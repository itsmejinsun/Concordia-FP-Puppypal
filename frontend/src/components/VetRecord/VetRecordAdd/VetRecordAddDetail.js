        ...
        if (inputData.date) {
            fetch(
                `/api/${localStorage.getItem(
                    'id'
                )}/puppy/${localStorage.getItem('pup')}/vetRecord`,
                {
                    method: 'POST',
                    headers: {
                ...
                .then((res) => res.json())
                .then((data) => {
                    setIsVetRecordAdded(!isVetRecordAdded);
                    setIsVetRecordAddOpen(false);
                });
        }
    };
...
export default VetRecordAddDetail;
